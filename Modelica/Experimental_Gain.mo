package Experimental_Gain
  ...
  model Ideal
    ...
    Modelica.Blocks.Interfaces.RealOutput y_2
      annotation (Placement(transformation(extent={{222,-118},{242,-98}})));
    Modelica.Blocks.Interfaces.RealOutput y_1
      annotation (Placement(transformation(extent={{214,38},{234,58}})));
  ...
  equation
    ...
    connect(G_22.y, L_22.u) annotation (
      Line(points={{101,-110},{119,-110},{118,-110}},                     color = {0, 0, 127}));
    ...
    connect(G_12.y, L_12.u) annotation (
      Line(points={{101,-70},{119,-70},{118,-70}},                    color = {0, 0, 127}));
    ...
    connect(G_12.u, u_22.y) annotation (
      Line(points={{78,-70},{60,-70},{60,-110},{50,-110},{51,-110}},                        color = {0, 0, 127}));
    ...
    connect(y_1, e_11.u2) annotation (Line(points={{224,48},{192,48},{192,58},{
            190,58},{190,80},{-120,80},{-120,58}}, color={0,0,127}));
    connect(y_2, y_22.y) annotation (Line(points={{232,-108},{181,-108},{181,
            -110}}, color={0,0,127}));
