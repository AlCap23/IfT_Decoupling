package WoodBerry_Gain
  ...
  equation
    ...
    connect(D_22.y, u_22.u2) annotation (
      Line(points={{1,-110},{9,-110},{9,-114},{27,-114},{27,-116},{27,-116},{28,
            -116}},                                                                                    color = {0, 0, 127}));
    connect(D_21.y, u_22.u1) annotation (
      Line(points={{1,-70},{19,-70},{19,-104},{27,-104},{27,-104},{27,-104},{28,
            -104}},                                                                                    color = {0, 0, 127}));
    connect(C_22.y, D_22.u) annotation (
  ...
  equation
    ...
    connect(K_11.u, C_11.y)
      annotation (Line(points={{38,50},{-39,50},{-39,50}}, color={0,0,127}));
