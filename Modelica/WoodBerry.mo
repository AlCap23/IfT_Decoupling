package WoodBerry
  ...
  Modelica.Blocks.Sources.Pulse r_22(amplitude = 1, period = 2400, startTime = 600, width = 50)  annotation (
    ...
    Modelica.Blocks.Interfaces.RealOutput y_2
      annotation (Placement(transformation(extent={{202,-120},{222,-100}})));
  ...
  equation
    ...
    connect(u_1, e_11.u1) annotation (Line(points={{-100,100},{-134,100},{-134,
            50},{-128,50}}, color={0,0,127}));
    connect(u_2, e_22.u1) annotation (Line(points={{-120,-152},{-128,-152},{
            -128,-136},{-134,-136},{-134,-110},{-128,-110}}, color={0,0,127}));
    connect(y_2, e_22.u2) annotation (Line(points={{212,-110},{194,-110},{193,
            -138},{-119,-138},{-119,-116},{-121,-116},{-121,-118},{-120,-118}},
          color={0,0,127}));
    connect(y_1, e_11.u2) annotation (Line(points={{210,48},{202,48},{202,52},{
            188,52},{188,50},{190,50},{190,80},{-120,80},{-120,58}}, color={0,0,
            127}));
    annotation (
  ...
  equation
    connect(Model.u, Source.y) annotation (
      Line(points={{-42,50},{-60,50},{-60,-30},{-79,-30},{-79,-30}},            color = {0, 0, 127}));
    connect(Source.y, Real_1.u) annotation (
      Line(points={{-79,-30},{-60,-30},{-60,10},{-42,10},{-42,10}},            color = {0, 0, 127}));
    connect(Source.y, Real_2.u) annotation (
      Line(points={{-79,-30},{-42,-30},{-42,-30},{-42,-30}},          color = {0, 0, 127}));
    connect(e.u1, Model.y) annotation (
      Line(points={{76,22},{20,22},{20,50},{-19,50},{-19,50}},            color = {0, 0, 127}));
    connect(e.u2, y_Real.y) annotation (
      Line(points={{76,10},{66,10},{66,-10},{61,-10},{61,-10}},            color = {0, 0, 127}));
    connect(y_Real.u2, Delay.y) annotation (
      Line(points={{38,-16},{30,-16},{30,-30},{21,-30},{21,-30}},            color = {0, 0, 127}));
    connect(Real_1.y, y_Real.u1) annotation (
      Line(points={{-19,10},{30,10},{30,-4},{38,-4},{38,-4}},            color = {0, 0, 127}));
