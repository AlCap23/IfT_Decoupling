package Experimental
  ...
  model Ideal
    ...
    Modelica.Blocks.Continuous.TransferFunction G_21(a={75.,1}, b={-0.5})            annotation (
      Placement(visible = true, transformation(origin={136,10},   extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction G_12(a={8.,1}, b={0.625})            annotation (
    ...
    Modelica.Blocks.Continuous.TransferFunction G_22(a = {20., 1}, b = {-1.75}) annotation (
      Placement(visible = true, transformation(origin={136,-110},   extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Modelica.Blocks.Math.Add y_11(k2 = 0) annotation (
      Placement(visible = true, transformation(origin={216,50},    extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Math.Add y_22(k1 = 0) annotation (
      Placement(visible = true, transformation(origin={216,-110},    extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Modelica.Blocks.Nonlinear.FixedDelay L_21(delayTime=2)   annotation (
    ...
    Modelica.Blocks.Nonlinear.FixedDelay L_22(delayTime = 2) annotation (
      Placement(visible = true, transformation(origin={176,-110},    extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Modelica.Blocks.Interfaces.RealOutput y_2
      annotation (Placement(transformation(extent={{268,-118},{288,-98}})));
  ...
  equation
    ...
    connect(G_22.y, L_22.u) annotation (
      Line(points={{147,-110},{165,-110},{164,-110}},                     color = {0, 0, 127}));
    connect(L_22.y, y_22.u2) annotation (
      Line(points={{187,-110},{197,-110},{197,-116},{205,-116},{204,-116}},                                      color = {0, 0, 127}));
    connect(G_12.y, L_12.u) annotation (
      Line(points={{147,-70},{165,-70},{164,-70}},                    color = {0, 0, 127}));
    connect(L_12.y, y_11.u2) annotation (
      Line(points={{187,-70},{200,-70},{200,44},{204,44}},          color = {0, 0, 127}));
    ...
    connect(y_22.y, e_22.u2) annotation (
      Line(points={{227,-110},{232,-110},{232,-108},{239,-108},{239,-138},{-73,
            -138},{-73,-116},{-75,-116},{-75,-118},{-120,-118}},                                                                                             color = {0, 0, 127}));
    connect(L_21.y, y_22.u1) annotation (
      Line(points={{187,10},{198,10},{198,-104},{204,-104}},          color = {0, 0, 127}));
    ...
    connect(y_11.y, e_11.u2) annotation (
      Line(points={{227,50},{236,50},{236,80},{-74,80},{-74,58},{-120,58}},                color = {0, 0, 127}));
    connect(L_11.y, y_11.u1) annotation (
      Line(points={{187,50},{194,50},{194,56},{204,56}},                     color = {0, 0, 127}));
    connect(D_11.y, u_11.u1) annotation (
      Line(points={{1,50},{14,50},{14,56},{30,56},{30,56}},            color = {0, 0, 127}));
    connect(G_21.y, L_21.u) annotation (
      Line(points={{147,10},{162,10},{164,10}},                   color = {0, 0, 127}));
    connect(G_11.y, L_11.u) annotation (
      Line(points={{147,50},{164,50}},                            color = {0, 0, 127}));
    ...
    connect(y_1, e_11.u2) annotation (Line(points={{270,48},{238,48},{238,58},{
            236,58},{236,80},{-120,80},{-120,58}}, color={0,0,127}));
    connect(y_2, y_22.y) annotation (Line(points={{278,-108},{227,-108},{227,
            -110}}, color={0,0,127}));
    connect(u_1, e_11.u1) annotation (Line(points={{-118,86},{-134,86},{-134,50},
            {-128,50}}, color={0,0,127}));
    connect(u_2, r_22.y) annotation (Line(points={{-114,-148},{-122,-148},{-122,
            -144},{-139,-144},{-139,-110}}, color={0,0,127}));
    connect(G_21.u, G_11.u) annotation (Line(points={{124,10},{112,10},{112,50},
            {124,50}}, color={0,0,127}));
    connect(G_12.u, G_22.u) annotation (Line(points={{124,-70},{120,-70},{120,
            -68},{112,-68},{112,-110},{124,-110}}, color={0,0,127}));
    connect(u_11.y, K_11.u)
      annotation (Line(points={{53,50},{64,50},{74,50}}, color={0,0,127}));
    connect(G_11.u, K_11.y)
      annotation (Line(points={{124,50},{110,50},{97,50}}, color={0,0,127}));
    connect(u_22.y, K_22.u) annotation (Line(points={{51,-110},{64,-110},{76,
            -110}}, color={0,0,127}));
    connect(G_22.u, K_22.y) annotation (Line(points={{124,-110},{112,-110},{99,
            -110}}, color={0,0,127}));
    annotation (
  ...
  model Decentralized
    ...
    Modelica.Blocks.Continuous.TransferFunction G_21(b={-0.5}, a={75.,1})      annotation (
      Placement(visible = true, transformation(origin={178,10},   extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction G_12(b={0.625}, a={8.,1})      annotation (
      Placement(visible = true, transformation(origin={178,-70},   extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction G_22(a = {20., 1}, b = {-1.75}) annotation (
      Placement(visible = true, transformation(origin={178,-108},   extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction D_11 annotation (
      Placement(visible = true, transformation(origin = {-10, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction D_12(a = {12.2}, b = {0}) annotation (
      Placement(visible = true, transformation(origin = {-10, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  equation
    ...
    connect(IE_1.u, e_11.y) annotation (
      Line(points={{-138,-10},{-100,-10},{-100,50},{-110,50},{-110,50},{-111,50}},              color = {0, 0, 127}));
    connect(G_22.y, L_22.u) annotation (
      Line(points={{189,-108},{206,-108},{206,-110}},                     color = {0, 0, 127}));
    connect(L_22.y, y_22.u2) annotation (
    ...
    connect(K_22.y, G_22.u)
      annotation (Line(points={{101,-110},{134,-110},{134,-108},{166,-108}},
                                                       color={0,0,127}));
    ...
    connect(u_1, e_11.u1) annotation (Line(points={{-118,86},{-128,86},{-128,50}},
          color={0,0,127}));
    connect(u_2, u_2) annotation (Line(points={{-114,-148},{-114,-148}},
                    color={0,0,127}));
  ...
  model Static_Decoupling
    Modelica.Blocks.Continuous.PI C_11(k=-9.0433, T=2.213062)   annotation (
      Placement(visible = true, transformation(origin = {-70, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.PI C_22(k=-1.6202827964378814, T=
          9.233382748499556)                                   annotation (
      Placement(visible = true, transformation(origin = {-70, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction G_11(a = {10., 1}, b = {-0.29}) annotation (
    ...
    Modelica.Blocks.Sources.Pulse r_22(amplitude = 1, period = 2400, startTime = 600, width = 50) annotation (
      Placement(visible = true, transformation(origin = {-150, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Math.Gain K_11(k=0.1)
      annotation (Placement(transformation(extent={{80,40},{100,60}})));
    Modelica.Blocks.Math.Gain K_22(k=0.1)
      annotation (Placement(transformation(extent={{80,-120},{100,-100}})));
    Modelica.Blocks.Interfaces.RealOutput y_1
  ...
  equation
    ...
    connect(IAE_2.u, abs_e2.y) annotation (
      Line(points={{-158,-70},{-140,-70},{-140,-70},{-141,-70}},          color = {0, 0, 127}));
    connect(e_22.y, C_22.u) annotation (
      Line(points={{-111,-110},{-81,-110},{-82,-110}},                     color = {0, 0, 127}));
    connect(L_21.y, y_22.u1) annotation (
    ...
    connect(D_21.y, u_22.u1) annotation (
      Line(points={{1,-70},{10,-70},{10,-68},{21,-68},{21,-102},{29,-102},{29,
            -105},{28,-105},{28,-104}},                                                                                      color = {0, 0, 127}));
    connect(C_22.y, D_22.u) annotation (
      Line(points={{-59,-110},{-23,-110},{-22,-110}},                     color = {0, 0, 127}));
    connect(D_21.u, C_11.y) annotation (
      Line(points={{-22,-70},{-40,-70},{-40,50},{-59,50}},          color = {0, 0, 127}));
    connect(D_12.u, C_22.y) annotation (
      Line(points = {{-22, 10}, {-36, 10}, {-36, -110}, {-59, -110}}, color = {0, 0, 127}));
    ...
    connect(C_11.y, D_11.u) annotation (
      Line(points={{-59,50},{-24,50},{-22,50}},                   color = {0, 0, 127}));
    connect(e_11.y, C_11.u) annotation (
      Line(points={{-111,50},{-84,50},{-82,50}},                   color = {0, 0, 127}));
    ...
    connect(K_11.u, u_11.y)
      annotation (Line(points={{78,50},{47,50}},         color={0,0,127}));
    ...
    connect(u_1, e_11.u1) annotation (Line(points={{-96,130},{-128,130},{-128,
            50}}, color={0,0,127}));
    connect(e_22.u2, y_22.y) annotation (Line(points={{-120,-118},{-122,-118},{
            -122,-126},{-122,-134},{240,-134},{240,-110},{231,-110}}, color={0,
            0,127}));
    connect(y_2, y_22.y) annotation (Line(points={{238,-38},{231,-38},{231,-110}},
          color={0,0,127}));
    annotation (
      __OpenModelica_simulationFlags(lv = "LOG_STATS", s = "dassl"),
      experiment(StartTime = 0, StopTime = 4800, Tolerance = 1e-10, Interval = 1),
  ...
  model Dynamic_Decoupling
    Modelica.Blocks.Continuous.PI C_11(k=-9.77756859921498, T=6.807343217251465)
                                                               annotation (
      Placement(visible = true, transformation(origin = {-70, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.PI C_22(k=-1.6202827964378816, T=
          9.061566917664416)                                   annotation (
      Placement(visible = true, transformation(origin = {-70, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction G_11(a = {10., 1}, b = {-0.29}) annotation (
  ...
  equation
    ...
    connect(LD_21.u, D_21.y) annotation (
      Line(points={{18,-70},{0,-70},{1,-70}},                  color = {0, 0, 127}));
    ...
    connect(LD_12.u, D_12.y) annotation (
      Line(points={{18,10},{0,10},{1,10}},                 color = {0, 0, 127}));
    connect(r_22.y, e_22.u1) annotation (
      Line(points={{-139,-110},{-130,-110},{-130,-110},{-128,-110}},          color = {0, 0, 127}));
    connect(r_11.y, e_11.u1) annotation (
      Line(points={{-139,50},{-130,50},{-130,50},{-128,50}},          color = {0, 0, 127}));
  ...
  model Inverse_Decoupling
    Modelica.Blocks.Continuous.PI C_11(T = 10., k=-10.*0.5/0.29)
                                                             annotation (
      Placement(visible = true, transformation(origin={-50,52},    extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.PI C_22(T = 20., initType = Modelica.Blocks.Types.Init.SteadyState,
      k=-20.*0.25/1.75)                                                                                         annotation (
  ...
  equation
    ...
    connect(tau_21.u, C_11.y) annotation (
      Line(points={{-18,-70},{0,-70},{0,52},{-39,52}},          color = {0, 0, 127}));
    ...
    connect(G_12.y, L_12.u) annotation (
      Line(points={{101,-70},{117,-70},{118,-70}},                                            color = {0, 0, 127}));
    connect(L_12.y, y_11.u2) annotation (
    ...
    connect(ed_11.y, C_11.u) annotation (
      Line(points={{-69,50},{-64,50},{-64,52},{-62,52}},          color = {0, 0, 127}));
    ...
    connect(G_21.y, L_21.u) annotation (
      Line(points={{101,10},{116,10},{118,10}},                   color = {0, 0, 127}));
    connect(G_11.y, L_11.u) annotation (
  ...
  model Centralized_PID
    ...
    Modelica.Blocks.Continuous.PI C_22(k=2.992, T=20.)                    annotation (
      Placement(visible = true, transformation(origin = {-50, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Modelica.Blocks.Continuous.TransferFunction G_21(                         y_start = 0,
      b={-0.5},
      a={75.,1})                                                                           annotation (
      Placement(visible = true, transformation(origin={192,12},   extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction G_12(                         y_start = 0,
      b={0.625},
      a={8.,1.})                                                                           annotation (
  ...
  equation
    ...
    connect(k2.y, C_22.u) annotation (
      Line(points={{-71,-110},{-67,-110},{-61,-110},{-62,-110}},                                                              color = {0, 0, 127}));
    ...
    connect(u_22.u2, C_22.y) annotation (
      Line(points={{18,-116},{9,-116},{0,-116},{0,-110},{-20.5,-110},{-39,-110}},                                        color = {0, 0, 127}));
    ...
    annotation (
      ...
      Diagram(coordinateSystem(extent={{-500,-500},{500,500}}, initialScale=0.1),
          graphics={Text(
            extent={{-158,392},{228,168}},
            lineColor={28,108,200},
            textString="DOES NOT WORK")}));
  end Centralized_PID;
end Experimental;
