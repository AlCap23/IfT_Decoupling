package Rosenbrock_SSV
  ...
  model Ideal
    ...
    Modelica.Blocks.Sources.Pulse r_22(amplitude = 1, period = 200, startTime = 100, width = 50) annotation(
      Placement(visible = true, transformation(origin = {-150, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction WI_11(a = {0.0333, 1}, b = {0.1, 0.1}) annotation(
      Placement(visible = true, transformation(origin = {-30, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction WI_22(a = {0.0333, 1}, b = {0.1, 0.1}) annotation(
      Placement(visible = true, transformation(origin = {-30, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction WP_11(a = {10., 1}, b = {0.1, 1.5}) annotation(
      Placement(visible = true, transformation(origin = {150, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Continuous.TransferFunction WP_22(a = {10., 1.}, b = {0.1, 1.5}) annotation(
      Placement(visible = true, transformation(origin = {150, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Math.Add u_22 annotation(
      Placement(visible = true, transformation(origin = {50, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Math.Add u_11 annotation(
      Placement(visible = true, transformation(origin = {50, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Gain d_11(k = 3)  annotation(
      Placement(visible = true, transformation(origin = {10, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Gain d_22(k = 10)  annotation(
      Placement(visible = true, transformation(origin = {10, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(d_22.y, u_22.u1) annotation(
      Line(points = {{22, -70}, {30, -70}, {30, -104}, {38, -104}, {38, -104}}, color = {0, 0, 127}));
    connect(d_22.u, WI_22.y) annotation(
      Line(points = {{-2, -70}, {-20, -70}, {-20, -70}, {-18, -70}}, color = {0, 0, 127}));
    connect(d_11.y, u_11.u2) annotation(
      Line(points = {{22, 10}, {28, 10}, {28, 44}, {38, 44}, {38, 44}}, color = {0, 0, 127}));
    connect(d_11.u, WI_11.y) annotation(
      Line(points = {{-2, 10}, {-18, 10}, {-18, 10}, {-18, 10}}, color = {0, 0, 127}));
    connect(WI_11.u, C_11.y) annotation(
      Line(points = {{-42, 10}, {-50, 10}, {-50, 50}, {-58, 50}, {-58, 50}}, color = {0, 0, 127}));
    connect(WI_22.u, C_22.y) annotation(
      Line(points = {{-42, -70}, {-50, -70}, {-50, -110}, {-58, -110}, {-58, -110}}, color = {0, 0, 127}));
    connect(u_11.y, G_11.u) annotation(
      Line(points = {{61, 50}, {78, 50}}, color = {0, 0, 127}));
    connect(u_11.u1, C_11.y) annotation(
      Line(points = {{38, 56}, {0, 56}, {0, 50}, {-58, 50}}, color = {0, 0, 127}));
    connect(u_22.y, G_22.u) annotation(
      Line(points = {{61, -110}, {78, -110}}, color = {0, 0, 127}));
    connect(u_22.u2, C_22.y) annotation(
      Line(points = {{38, -116}, {0, -116}, {0, -110}, {-58, -110}}, color = {0, 0, 127}));
    connect(WP_22.u, G_22.y) annotation(
      Line(points = {{138, -110}, {100, -110}, {100, -110}, {102, -110}}, color = {0, 0, 127}));
    connect(WP_11.u, G_11.y) annotation(
      Line(points = {{138, 50}, {100, 50}, {100, 50}, {102, 50}}, color = {0, 0, 127}));
    connect(r_22.y, e_22.u1) annotation(
      Line(points = {{-138, -110}, {-128, -110}, {-128, -110}, {-128, -110}}, color = {0, 0, 127}));
    connect(r_11.y, e_11.u1) annotation(
      Line(points = {{-138, 50}, {-128, 50}, {-128, 50}, {-128, 50}}, color = {0, 0, 127}));
